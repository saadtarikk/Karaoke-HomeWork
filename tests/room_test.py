...
class TestRoom(unittest.TestCase):
    ...
    def test_add_single_guest_to_room(self):
        ...
        self.assertEqual(3, len(self.room1.room_playlist))
        self.assertEqual("whoo", self.room1.guest_cheer(self.guest))

    
    def test_can_add_guests_to_room_true(self):
        self.room2.add_guests_to_room(self.guests1, self.room2, self.playlist)
        ...
        self.assertEqual(6, len(self.room2.room_playlist))
        self.assertEqual("whoo", self.room2.guest_cheer(self.guest))
