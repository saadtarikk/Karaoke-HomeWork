...
class TestRoom(unittest.TestCase):
    ...
    def test_till_accepts_money(self):
        self.room1.till_accepts_money(self.guest, self.room1)
        self.assertEqual(20, self.room1.till)
    
    def test_customer_pays_for_room(self):
        self.room1.till_accepts_money(self.guest1, self.room1)
    ...
    def test_add_single_guest_to_room(self):
        self.room1.add_single_guest_to_room(self.guest)
        self.assertEqual(1, len(self.room1.occupants))

    def test_can_add_guests_to_room_true(self):
        self.room2.add_guests_to_room(self.guests1)
        self.assertEqual(2, len(self.room2.occupants))

    def test_can_add_guest_room_false(self):
        self.assertEqual("Capacity reached", self.room2.add_guests_to_room(self.guests2))

    def test_cant_pay_for_room(self):
        self.assertEqual("Alex doesn't have enough cash", self.room2.add_guests_to_room(self.guests3))
